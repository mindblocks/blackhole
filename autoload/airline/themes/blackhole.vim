...
function! airline#themes#blackhole#refresh()
  let g:airline#themes#blackhole#palette.accents = {
  ...
  let g:airline#themes#blackhole#palette.normal_modified = {
  ...
  let g:airline#themes#blackhole#palette.insert_modified = g:airline#themes#blackhole#palette.normal_modified
  ...
  let g:airline#themes#blackhole#palette.replace_modified = g:airline#themes#blackhole#palette.normal_modified
  ...
  let g:airline#themes#blackhole#palette.visual_modified = g:airline#themes#blackhole#palette.normal_modified

  let s:IA = airline#themes#get_highlight2(['NonText', 'fg'], ['CursorLine', 'bg'])
  let g:airline#themes#blackhole#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
  let g:airline#themes#blackhole#palette.inactive_modified = {
        \ 'airline_c': [ group[0], '', group[2], '', '' ]
        \ }
endfunction

call airline#themes#blackhole#refresh()
